...
Download [**here**](https://gin.g-node.org/Aswendt_Lab/testdata_AIDA) (you may need to browse the archive or the repository and directly download the test-data file from there. Do not download the zipped archive).\
