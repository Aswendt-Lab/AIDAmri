...
if __name__ == "__main__":
    ...
    fslMeantsFile = fsl_mean_ts.start_fsl_mean_ts(srgr_file, roisPath, labelNames, 'MasksTCs.')
    ...
    fslMeantsFile = fsl_mean_ts.start_fsl_mean_ts(srgr_file, roisPath, labelNames2000, 'MasksTCsSplit.')
