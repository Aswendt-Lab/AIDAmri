...
def regABA2DTI(inputVolume,stroke_mask,refStroke_mask,T2data, brain_template,brain_anno, splitedAnno,splitedAnno_rsfMRI,anno_rsfMRI,bsplineMatrix,outfile):
...
if __name__ == "__main__":
    ...
    output = regABA2DTI(inputVolume, stroke_mask, refStroke_mask, T2data, brain_template, brain_anno, splitedAnno,splitedAnno_rsfMRI,anno_rsfMRI,bsplineMatrix,outfile)
    print(output + '...DONE!')
